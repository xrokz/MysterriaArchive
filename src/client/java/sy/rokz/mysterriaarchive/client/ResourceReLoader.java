...
public class ResourceReLoader extends SimplePreparableReloadListener<Map<Identifier, JsonElement>> implements IdentifiableResourceReloadListener {
    ...
    public @NonNull Identifier getFabricId() {
        return Identifier.fromNamespaceAndPath("mys", "client_json_loader");
    }
